...
Cover preference for Sources / identity (PR3): **type icon** by default, or an
**explicitly pinned Artifact raster**. No first-file auto-pin; Source never paints
file-type glyphs. Artifact rows **with a File** stay raster → MIME; **fileless**
