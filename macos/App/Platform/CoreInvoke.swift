...
enum CoreMethod {
    ...
    static let listProjectUsers = Int32(Provenance_Engine_V1_Method.listProjectUsers.rawValue)
    static let signOut = Int32(Provenance_Engine_V1_Method.signOut.rawValue)
}
