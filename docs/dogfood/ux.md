...
- **Pulled into Spike 8:** image **Auto Transcribe** ([`S8-D1`](../deployment-plan/spike-8/design/S8-D1-auto-transcribe.md) / [`S8-01`](../deployment-plan/spike-8/deployment-plan.md)); PDF **Find** + **select** + **paste transcription** ([`S8-D2`](../deployment-plan/spike-8/design/S8-D2-pdf-text-find.md) / [`S8-03…S8-05`](../deployment-plan/spike-8/deployment-plan.md); notes: [`pdf-text-find.md`](../deployment-plan/spike-8/pdf-text-find.md)). PDF OCR / Vision on page rasters stay out. Composer rethink (pinning, empty Citation, multi-subject reading) and Foundation Models stay here.
