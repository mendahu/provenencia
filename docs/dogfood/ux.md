...
- **Folded in from interpretation-graph-ui leftovers:** **Citation pinning** across graph edits (same reading, more Observations / more subjects) and **Citation with zero Observations** (“I transcribed this line; I have not interpreted it yet”). Today Save refuses an empty Observation list. Both are UI policy on a per-subject composer, not schema gaps. A more flexible composer absorbs them; do not schedule a standalone pinning or empty-Citation story.
...
- **Pulled into Spike 8:** image **Auto Transcribe** ([`S8-D1`](../deployment-plan/spike-8/design/S8-D1-auto-transcribe.md) / [`S8-01`](../deployment-plan/spike-8/deployment-plan.md)); PDF **Find** + **select** + **paste transcription** ([`S8-D2`](../deployment-plan/spike-8/design/S8-D2-pdf-text-find.md) / [`S8-03…S8-05`](../deployment-plan/spike-8/deployment-plan.md); notes: [`pdf-text-find.md`](../deployment-plan/spike-8/pdf-text-find.md)); Source page **Open Evidence graph** ([`S8-D4`](../deployment-plan/spike-8/design/S8-D4-source-page.md) / [`S8-07`](../deployment-plan/spike-8/deployment-plan.md)). PDF OCR / Vision on page rasters stay out. Composer rethink (pinning, empty Citation, multi-subject reading) and Foundation Models stay here.
