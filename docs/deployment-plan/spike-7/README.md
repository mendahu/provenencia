...
| [Design briefs](design/) | Claude Design — S7-D2 through S7-D9 are finished (see [completed.md](completed.md)); S7-D1 descoped. Open: **S7-D10** (Select native-popup + remount) gates **S7-15**, then **S7-11**. |
