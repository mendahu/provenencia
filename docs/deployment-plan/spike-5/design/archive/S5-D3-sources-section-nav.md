...
**Related briefs:** archived [`S5-D2`](S5-D2-sources-list-graph-entry.md) (Sources list → Evidence graph); archived [`S5-D1`](S5-D1-interpretation-nav-entry.md) (**superseded** — do not implement)
