...
| --- | --- | --- | --- |
| S8-D7 | [`S8-D7-composer-rethink.md`](S8-D7-composer-rethink.md) | PR **S8-10** | **First.** Compact Artifact vs Citation (ref + transcription); inline text/integer; replace pre-screen |
