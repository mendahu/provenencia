...
| --- | --- | --- | --- |
| S8-D5 | [`archive/S8-D5-sources-list.md`](archive/S8-D5-sources-list.md) | **S8-08** | Graph-zone subject + observation counts; 248pt zone; `0 subjects · not started`; counts on their own session map, not `sourcesList`. |
