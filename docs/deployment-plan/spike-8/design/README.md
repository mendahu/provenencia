...
| --- | --- | --- | --- |
| S8-D4 | [`S8-D4-source-page.md`](S8-D4-source-page.md) | PR **S8-07** | Restore shipped metadata + dates as text + delete (jump already on the board) |
