...
| [Design briefs](design/) | Claude Design — **S8-D7** first, then **S8-D8**, then **S8-D1**…**S8-D6** (**S8-02** has no board). Working rules: [`design/claude-design-working-rules.md`](design/claude-design-working-rules.md) |
